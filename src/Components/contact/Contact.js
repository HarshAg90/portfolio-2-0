...
export default function Contact() {
  return (
    <div id="contact">
        ...
        <div className="links">
          <a href="https://www.instagram.com/sudo.harsh/" className="insta">
            <img src={instagram} alt="" />
          </a>
          <a href="https://twitter.com/HarshAg90" className="twitter">
            <img src={twitter} alt="" />
          </a>
          <a href="https://www.linkedin.com/in/harshag90/" className="linkedin">
